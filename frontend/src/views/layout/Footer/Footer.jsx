            ...
            <div className="container">
                ...
                <div className="row py-4">
                    ...
                    <div className="col-3 border-right border-grey-100">
                        ...
                        <ul>
                            <li><Link to="/strefa-stylistki/rekrutacja">kariera</Link></li>
                            <li><Link to="#">warunki</Link></li>
                        ...
                        <div className="row">
                            <div className="col-4">
                                ...
                                <ul className="mb-3">
                                    ...
                                    <li><Link to="#">stylistki</Link></li>
                                    <li><Link to="#">blog</Link></li>
                                </ul>
                                <div>
                                    <span className="mr-2"><FontAwesomeIcon icon={faFacebook} /></span>
                                    <span className="mr-2"><FontAwesomeIcon icon={faInstagram} /></span>
                            ...
                            <div className="col-4 ">
                                ...
                                <ul>
                                    ...
                                    <li><Link to="#">standard usług</Link></li>
                                </ul>
                            </div>
                            ...
                            <div className="col-4">
                                ...
                                <div className="input-group">
                                    ...
                                    <div className="input-group-append">
                                        <button className="btn btn-primary" type="button">Zapisz się</button>
                                    </div>
                                </div>
                ...
                <div>
                    ...
                    <h6 className="text-center">Realizacja: <Link to="https://www.webite.pl/">WEBite.pl</Link></h6>
                </div>
