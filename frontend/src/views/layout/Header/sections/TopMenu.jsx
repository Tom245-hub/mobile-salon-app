  ...
  return (
    <ul className="TopMenu menu-top d-flex h-100">
      <li className="menu-item d-flex align-items-center mx-2">
        ...
        <ContainerSubmenu
          className={
            "container-fluid bg-white py-5" +
            (props.activeSubmenu === 1 ? " d-block" : "")
          }
          ...
          <div className="row w-100 d-flex justify-content-around px-5">
            <div className="col d-flex flex-row align-items-center">
              <div className="d-flex flex-column">
                ...
                <Link
                  className="mb-2"
                  to="/uslugi/fryzury-slubne"
                  onClick={() => props.setActiveSubmenu(0)}
