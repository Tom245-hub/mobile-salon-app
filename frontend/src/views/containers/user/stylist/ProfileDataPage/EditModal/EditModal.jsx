                ...
                <div className='row d-flex justify-content-center'>
                  <div className='col-12'>
                    <form onSubmit={handleSubmit} noValidate>
                      ...
                      <textarea className='form-control mb-2' id='text' type='text' name='text' placeholder='Opis' value={values.text} onChange={handleChange} onBlur={handleBlur} rows='6'></textarea>
