...
import LinkList from "../UIELements//LinkList";
import ContainerSubmenu from "../UIELements/ContainerSubmenu";

const TopMenu = (props) => {
  const { categoryList, cityList } =
          ...
          <div className='col d-flex flex-row align-items-center'>
            <div className='d-flex flex-column'>
              <LinkList
                title='Usługi'
                links={categoryList}
                setActiveSubmenu={props.setActiveSubmenu}
              />
            </div>
          </div>
